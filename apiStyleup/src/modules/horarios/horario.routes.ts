...
import {
  ...
  listHorariosByBarberoController,
  replaceHorarioBarberoController,
  updateHorarioController,
} from "./horario.controller.js";
import {
  createHorarioSchema,
  horarioBarberoParamsSchema,
  idHorarioParamsSchema,
  replaceHorarioBarberoSchema,
  updateHorarioSchema,
...
horarioRoutes.get(
  "/barbero/:cedula_barbero",
  auth,
  validate(horarioBarberoParamsSchema),
  listHorariosByBarberoController,
);
horarioRoutes.put(
  "/barbero/:cedula_barbero",
  auth,
  validate(replaceHorarioBarberoSchema),
  replaceHorarioBarberoController,
);
