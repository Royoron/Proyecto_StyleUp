...
especialidadRoutes.post(
  ...
  validate(createEspecialidadSchema),
  createEspecialidadController,
);

especialidadRoutes.put(
  "/:id_especialidad",
  auth,
  authorize(["SUPERADMIN"]),
  validate(updateEspecialidadSchema),
  updateEspecialidadController,
);

especialidadRoutes.delete(
  "/:id_especialidad",
  auth,
  authorize(["SUPERADMIN"]),
  validate(getEspecialidadSchema),
