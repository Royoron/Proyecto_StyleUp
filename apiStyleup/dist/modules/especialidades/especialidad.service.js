...
export async function getEspecialidadById(id_especialidad) {
...
export async function updateEspecialidad(id_especialidad, patch) {
...
export async function deleteEspecialidad(id_especialidad) {
    ...
    if (barberosCount > 0 || citasCount > 0) {
        throw new ApiError(StatusCodes.CONFLICT, "No se puede eliminar la especialidad porque esta en uso");
    }
