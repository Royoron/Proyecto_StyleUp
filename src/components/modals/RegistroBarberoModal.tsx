...
export default function RegistroBarberoModal({
  ...
  const handleSubmit = async () => {
    const { nombre, apellido, correo, cedula, password, id_especialidad, hora_inicio, hora_fin } = form;

    if (!nombre || !apellido || !correo || !cedula || !password || !id_especialidad) {
    ...
    const { ok, mensaje } = registrarBarbero({
      nombre,
      apellido,
      correo,
        ...
        <div className="su-modal-body">
          ...
          <div className="row g-3">
            <div className="col-6">
              ...
              <input className="campo-formulario" name="nombre" value={form.nombre} onChange={handleChange} />
            </div>
            <div className="col-6">
              <label className="etiqueta-campo">Apellido *</label>
              <input className="campo-formulario" name="apellido" value={form.apellido} onChange={handleChange} />
            </div>
            <div className="col-12">
              <label className="etiqueta-campo">Especialidad *</label>
              <select className="campo-formulario" name="id_especialidad" value={form.id_especialidad} onChange={handleChange}>
            ...
            <div className="col-6">
              ...
              <input className="campo-formulario" type="email" name="correo" value={form.correo} onChange={handleChange} />
            </div>
            <div className="col-6">
              <label className="etiqueta-campo">Teléfono</label>
              <input className="campo-formulario" name="telefono" value={form.telefono} onChange={handleChange} />
            </div>
            <div className="col-6">
              <label className="etiqueta-campo">Cédula *</label>
              <input className="campo-formulario" name="cedula" value={form.cedula} onChange={handleChange} />
            </div>
            <div className="col-6">
              <label className="etiqueta-campo">Días base</label>
              <input className="campo-formulario" value="Lunes a viernes" disabled />
            </div>
            <div className="col-6">
              <label className="etiqueta-campo">Hora inicio</label>
              <input className="campo-formulario" type="time" name="hora_inicio" value={form.hora_inicio} onChange={handleChange} />
            </div>
            <div className="col-6">
              <label className="etiqueta-campo">Hora fin</label>
              <input className="campo-formulario" type="time" name="hora_fin" value={form.hora_fin} onChange={handleChange} />
            </div>
            <div className="col-6">
              <label className="etiqueta-campo">Contraseña *</label>
              <input className="campo-formulario" type="password" name="password" value={form.password} onChange={handleChange} />
            </div>
            <div className="col-6">
              <label className="etiqueta-campo">Confirmar *</label>
              <input className="campo-formulario" type="password" value={confirmar} onChange={e => { setConfirmar(e.target.value); setError(''); }} />
            </div>
          </div>
          ...
          <button className="btn-principal w-100 su-btn-submit mt-3" onClick={handleSubmit} disabled={cargando}>
            {cargando
              ? <><i className="bi bi-arrow-repeat su-spin me-2" />Creando perfil...</>
              : <><i className="bi bi-scissors me-2" />Crear perfil de barbero</>
            }
          </button>
