...
export type PanelId =
  ...
  | "historial"
  | "perfil";
export type PanelBarberoId =
  | "agenda"
  | "citas"
  | "horario"
  | "historial"
  | "perfil";
export type RolUsuario = "cliente" | "barbero" | "superadmin";
...
// ── BARBERO PERFIL (sin password) ─────────────────────────
export interface BarberoPerfil extends Barbero {
  horario: FranjaHoraria[];
}
...
export interface Sesion {
  usuario: Cliente | BarberoPerfil | SuperAdmin;
  rol: RolUsuario;
}
